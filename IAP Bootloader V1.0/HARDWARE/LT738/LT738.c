...
* Version         : V1.0
* Date            : 2019-1-23
* Description     : 操作LT738的寄存器函数
				    具体操作哪个寄存器请看LT738.h文件
*********************************************************/
...
void LT738_SW_Reset(void)//IC Reset
{
	unsigned char temp;
...
{
/*
Draw task finished | BTE Process Complete etc. Interrupt flag
