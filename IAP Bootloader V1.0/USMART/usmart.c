...
#if USMART_USE_HELP 
		  printf("------------------------USMART---------------------------- \r\n");
			printf("    USMART是一个灵巧的串口调试互交组件,通过它,你可以通过串口 \r\n");
			printf("助手调用程序里面的任何函数,并执行.因此,你可以随意更改函数的输\r\n");
			printf("入参数(支持数字(10/16进制)、字符串、函数入口地址等作为参数),单\r\n");	  
			printf("个函数最多支持10个输入参数,并支持函数返回值显示.新增参数显示 \r\n");
			printf("进制设置功能,新增进制转换功能.\r\n");
