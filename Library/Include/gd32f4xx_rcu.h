...
#define RCU_AHB1Periph_GPIOJ             ((uint32_t)0x00000200)
#define RCU_AHB1Periph_GPIOK             ((uint32_t)0x00000400)
#define RCU_AHB1Periph_CRC               ((uint32_t)0x00001000)
#define RCU_AHB1Periph_FLITF             ((uint32_t)0x00008000)
#define RCU_AHB1Periph_SRAM1             ((uint32_t)0x00010000)
#define RCU_AHB1Periph_SRAM2             ((uint32_t)0x00020000)
#define RCU_AHB1Periph_BKPSRAM           ((uint32_t)0x00040000)
#define RCU_AHB1Periph_SRAM3             ((uint32_t)0x00080000)
#define RCU_AHB1Periph_CCMDATARAMEN      ((uint32_t)0x00100000)
#define RCU_AHB1Periph_DMA1              ((uint32_t)0x00200000)
#define RCU_AHB1Periph_DMA2              ((uint32_t)0x00400000)
...
#if defined (gd32F427_437xx) || defined (gd32F429_439xx) 
...
/** @defgroup RCU_APB1_Peripherals 
  * @{
  */ 
#define RCU_APB1Periph_TIM2              ((uint32_t)0x00000001)
#define RCU_APB1Periph_TIM3              ((uint32_t)0x00000002)
#define RCU_APB1Periph_TIM4              ((uint32_t)0x00000004)
#define RCU_APB1Periph_TIM5              ((uint32_t)0x00000008)
#define RCU_APB1Periph_TIM6              ((uint32_t)0x00000010)
#define RCU_APB1Periph_TIM7              ((uint32_t)0x00000020)
#define RCU_APB1Periph_TIM12             ((uint32_t)0x00000040)
#define RCU_APB1Periph_TIM13             ((uint32_t)0x00000080)
#define RCU_APB1Periph_TIM14             ((uint32_t)0x00000100)
#define RCU_APB1Periph_WWDG              ((uint32_t)0x00000800)
#define RCU_APB1Periph_SPI2              ((uint32_t)0x00004000)
#define RCU_APB1Periph_SPI3              ((uint32_t)0x00008000)
#define RCU_APB1Periph_USART2            ((uint32_t)0x00020000)
#define RCU_APB1Periph_USART3            ((uint32_t)0x00040000)
#define RCU_APB1Periph_UART4             ((uint32_t)0x00080000)
#define RCU_APB1Periph_UART5             ((uint32_t)0x00100000)
#define RCU_APB1Periph_I2C1              ((uint32_t)0x00200000)
#define RCU_APB1Periph_I2C2              ((uint32_t)0x00400000)
#define RCU_APB1Periph_I2C3              ((uint32_t)0x00800000)
#define RCU_APB1Periph_CAN1              ((uint32_t)0x02000000)
#define RCU_APB1Periph_CAN2              ((uint32_t)0x04000000)
#define RCU_APB1Periph_PWR               ((uint32_t)0x10000000)
#define RCU_APB1Periph_DAC               ((uint32_t)0x20000000)
#define RCU_APB1Periph_UART7             ((uint32_t)0x40000000)
#define RCU_APB1Periph_UART8             ((uint32_t)0x80000000)
...
/** @defgroup RCU_APB2_Peripherals 
  * @{
  */ 
#define RCU_APB2Periph_TIM1              ((uint32_t)0x00000001)
#define RCU_APB2Periph_TIM8              ((uint32_t)0x00000002)
#define RCU_APB2Periph_USART1            ((uint32_t)0x00000010)
#define RCU_APB2Periph_USART6            ((uint32_t)0x00000020)
#define RCU_APB2Periph_ADC               ((uint32_t)0x00000100)
#define RCU_APB2Periph_ADC1              ((uint32_t)0x00000100)
#define RCU_APB2Periph_ADC2              ((uint32_t)0x00000200)
#define RCU_APB2Periph_ADC3              ((uint32_t)0x00000400)
#define RCU_APB2Periph_SDIO              ((uint32_t)0x00000800)
#define RCU_APB2Periph_SPI1              ((uint32_t)0x00001000)
#define RCU_APB2Periph_SPI4              ((uint32_t)0x00002000)
#define RCU_APB2Periph_SYSCFG            ((uint32_t)0x00004000)
#define RCU_APB2Periph_TIM9              ((uint32_t)0x00010000)
#define RCU_APB2Periph_TIM10             ((uint32_t)0x00020000)
#define RCU_APB2Periph_TIM11             ((uint32_t)0x00040000)
#define RCU_APB2Periph_SPI5              ((uint32_t)0x00100000)
#define RCU_APB2Periph_SPI6              ((uint32_t)0x00200000)
