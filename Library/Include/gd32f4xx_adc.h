...
#if defined (GD32F427) || defined (STM32F429_439xx) || defined (STM32F401xx) || defined (STM32F410xx) || defined (STM32F411xE)
...
FlagStatus ADC_GetITStatus(ADC_TypeDef* ADCx, uint16_t ADC_IT);
