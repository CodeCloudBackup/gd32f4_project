 ...
 ===============================================================================
    [..]
      (#) Enable peripheral clock using the following functions
          RCU_APB2PeriphClockCmd(RCU_APB2Periph_USARTx, ENABLE) for USART1 and USART6 
          RCU_APB1PeriphClockCmd(RCU_APB1Periph_USARTx, ENABLE) for USART2, USART3, 
          UART4 or UART5.
  
      (#) According to the USART mode, enable the GPIO clocks using 
          RCU_AHB1PeriphClockCmd() function. (The I/O can be TX, RX, CTS, 
          or/and SCLK). 
    ...
    This function should be called after enabling the USART clock (RCU_APBxPeriphClockCmd())
...
void USART_DeInit(USART_TypeDef* USARTx)
{
  ...
  if (USARTx == USART0)
  {
    RCU_APB2PeriphResetCmd(RCU_APB2Periph_USART0, ENABLE);
    RCU_APB2PeriphResetCmd(RCU_APB2Periph_USART0, DISABLE);
  }
...
/*---------------------------- USART BRR Configuration -----------------------*/
  ...
  if ((USARTx == USART0) || (USARTx == USART5))
  {
    apbclock = RCU_ClocksStatus.PCLK2_Frequency;
  }
  else
  {
    apbclock = RCU_ClocksStatus.PCLK1_Frequency;
  }
