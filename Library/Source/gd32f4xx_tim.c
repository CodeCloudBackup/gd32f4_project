...
@verbatim   
 ...
 ===============================================================================
    ...
    To use the Timer in Timing(Time base) mode, the following steps are mandatory:
      ...
      (#) Enable TIM clock using RCU_APBxPeriphClockCmd(RCU_APBxPeriph_TIMx, ENABLE) function
...
@verbatim   
 ...
 ===============================================================================
    ...
    To use the Timer in Output Compare mode, the following steps are mandatory:
      ...
      (#) Enable TIM clock using RCU_APBxPeriphClockCmd(RCU_APBxPeriph_TIMx, ENABLE) 
          function
