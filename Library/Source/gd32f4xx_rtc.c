...
@endverbatim
  ...
  * @attention
  *
  * <h2><center>&copy; COPYRIGHT 2014 gdicroelectronics</center></h2>
  *
...
/** @addtogroup gd32F4xx_StdPeriph_Driver
  * @{
  */
...
/**
  ...
  *         registers.       
  * @param  None
  * @retval An ErrStatus enumeration value:
...
/**
  ...
  */
ErrStatus RTC_Init(RTC_InitTypeDef* RTC_InitStruct)
{
  ErrStatus status = ERROR;
...
/**
  ...
  */
ErrStatus RTC_EnterInitMode(void)
{
...
/**
  ...
  */
ErrStatus RTC_WaitForSynchro(void)
{
...
/**
  ...
  */
ErrStatus RTC_RefClockCmd(FunctionalState NewState)
{ 
  ErrStatus status = ERROR;
...
/**
  ...
  */
ErrStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
  ErrStatus status = ERROR;
...
/**
  ...
  */
ErrStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  uint32_t tmpreg = 0;
  ErrStatus status = ERROR;
...
/**
  ...
  */
ErrStatus RTC_AlarmCmd(uint32_t RTC_Alarm, FunctionalState NewState)
{
...
/**
  ...
  * @retval None
  */
ErrStatus RTC_WakeUpCmd(FunctionalState NewState)
{
  __IO uint32_t wutcounter = 0x00;
  uint32_t wutwfstatus = 0x00;
  ErrStatus status = ERROR;
...
/**
  ...
  * @param  RTC_DayLightSaveOperation: the value of hour adjugdent. 
  *          This parameter can be one of the following values:
...
/**
  ...
  */
ErrStatus RTC_CoarseCalibConfig(uint32_t RTC_CalibSign, uint32_t Value)
{
  ErrStatus status = ERROR;
...
/**
  ...
  */
ErrStatus RTC_CoarseCalibCmd(FunctionalState NewState)
{
  ErrStatus status = ERROR;
...
*/
ErrStatus RTC_SmoothCalibConfig(uint32_t RTC_SmoothCalibPeriod,
...
*/
ErrStatus RTC_SynchroShiftConfig(uint32_t RTC_ShiftAdd1S, uint32_t RTC_ShiftSubFS)
{
  ErrStatus status = ERROR;
...
/**
  ...
  */
FlagStatus RTC_GetITStatus(uint32_t RTC_IT)
{
  FlagStatus bitstatus = RESET;
...
/************************ (C) COPYRIGHT gdicroelectronics *****END OF FILE****/
