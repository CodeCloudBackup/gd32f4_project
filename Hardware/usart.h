...
#define USART0_REC_LEN  			16*4096   	//¶¨Òå×î´ó½ÓÊÕ×Ö½ÚÊı 200
#define EN_USART0_RX 			1		//Ê¹ÄÜ£¨1£©/½ûÖ¹£¨0£©´®¿Ú1½ÓÊÕ

#define USART5_MAX_RECV_LEN		800					//×î´ó½ÓÊÕ»º´æ×Ö½ÚÊı
#define USART5_MAX_SEND_LEN		800					//×î´ó·¢ËÍ»º´æ×Ö½ÚÊı
...
extern __IO u16 USART5_RX_STA;   						//½ÓÊÕÊı¾İ×´Ì¬
