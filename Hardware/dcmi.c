...
{ 
  ...
  RCU_AHB1PeriphClockCmd(RCU_AHB1Periph_DMA1,ENABLE);//DMA2时钟使能 
	DMA_DeInit(DMA1_Stream1);//等待DMA1_Stream1
	while (DMA_GetCmdStatus(DMA1_Stream1) != DISABLE){}//等待DMA1_Stream1可配置 
...
void MyDCMI_Init(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6;//PE4/5/6 D4/6/7 复用功能输出
  GPIO_Init(GPIOE, &GPIO_InitStructure);//初始化	

  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9|GPIO_Pin_11;//PG9/11 VSYNC/D3复用功能输出 
