...
struct inv_imu_device {
    ...
    uint32_t gyro_start_time_us; /**< Gyro start time used to discard first samples */
	uint32_t accel_start_time_us; /**< Accel start time used to discard first samples */
	uint32_t gyro_power_off_tmst; /**< Gyro power off time */
};
